...
4. Surface face: projection, tessellation, tangent occlusion, eye tilt, nose/mouth geometry, and face-shadow attenuation.
5. Camera: mode, background, frame clip, edge clearance, and export size.
6. Effects: lighting, grid density, face shadow, avatar shadow, outline, and frame shadow.
...
- `src/InteractiveAvatar.tsx`: assembled rendering, materials, projection, occlusion, and depth ordering.
