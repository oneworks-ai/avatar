...
- Confirm entity, part materials, rotated depth order, pose, surface face, lighting, shadows, outline, background, and frame.
...
- For circle and rounded frames, outer corner pixels should be fully transparent because of frame clipping.
...
- Treat GIF transparency as a constrained indexed format; inspect edges against the intended destination background when visual quality matters.
