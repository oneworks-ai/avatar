...
export const AVATAR_ENTITY_PRESETS = ['custom', 'cloud', 'sun', 'cat', 'dog', 'bear', 'red-panda', 'otter', 'rabbit', 'bun'] as const

export type AvatarEntityPreset = (typeof AVATAR_ENTITY_PRESETS)[number]

export const AVATAR_BUILT_IN_ENTITY_PRESETS = ['cloud', 'sun', 'cat', 'dog', 'bear', 'red-panda', 'otter', 'rabbit', 'bun'] as const satisfies readonly AvatarEntityPreset[]
...
const OTTER_PARTS: readonly AvatarEntityPart[] = [
  { ...OTTER_EAR_MATERIAL, face: false, id: 'otter-ear-left', label: 'Left ear', occludedByFace: true, occlusionAmount: 8, occlusionPole: 'bottom', rotationX: -4, rotationY: -8, rotationZ: -7, scaleX: .17, scaleY: .2, scaleZ: .16, shape: 'sphere', x: -78, y: -32, z: -14 },
  { ...OTTER_EAR_MATERIAL, face: false, id: 'otter-ear-right', label: 'Right ear', occludedByFace: true, occlusionAmount: 8, occlusionPole: 'bottom', rotationX: -4, rotationY: 8, rotationZ: 7, scaleX: .17, scaleY: .2, scaleZ: .16, shape: 'sphere', x: 78, y: -32, z: -14 },
  { ...OTTER_MATERIAL, face: true, id: 'otter-head', label: 'Head', scaleX: .79, scaleY: .76, scaleZ: .7, shape: 'ellipse', x: 0, y: 16, z: 0 }
]
