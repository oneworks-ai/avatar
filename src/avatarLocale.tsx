...
const ZH_HANS_TRANSLATIONS: Readonly<Record<string, string>> = {
  ...
  'Animation mode': '动画模式',
  'Animation name': '动画名称',
  'Add color shapes that follow the model surface.': '添加会贴合模型曲面的颜色形状。',
  'Add decal': '添加贴花',
  ...
  'Surprised': '惊讶',
  'Teardrop': '水滴形',
  'This entity uses multiple materials. Applying this palette will replace all part colors.': '这个形象包含多种部件材质。应用此配色会覆盖所有部件颜色。',
